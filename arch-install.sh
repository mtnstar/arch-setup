...
pacstrap -K /mnt base linux "$microcode" linux-firmware linux-headers sbctl btrfs-progs grub grub-btrfs rsync efibootmgr snapper reflector snap-pac zram-generator sudo ansible &>/dev/null
